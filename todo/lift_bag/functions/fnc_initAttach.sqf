...
private _balloon = _ballonTyp createVehicle [_pos select 0, _pos select 1, ((_pos select 2) +2)];
...
private _slingMemPoints = getArray (configFile >> "CfgVehicles" >> _hookedObj >> "slingLoadCargoMemoryPoints");
_slingMemPoints params ["_attachPoint1", "_attachPoint2", "_attachPoint3", "_attachPoint4"];

private _myRope1 = ropeCreate [_balloon, "Attach_Point_D_1", _hookedObj, _attachPoint1];
private _myRope2 = ropeCreate [_balloon, "Attach_Point_D_1", _hookedObj, _attachPoint2];
private _myRope3 = ropeCreate [_balloon, "Attach_Point_D_2", _hookedObj, _attachPoint3];
private _myRope4 = ropeCreate [_balloon, "Attach_Point_D_2", _hookedObj, _attachPoint4];
_hookedObj setVariable ["Grad_Liftbag_Ropes", [_myRope1, _myRope2, _myRope3, _myRope4]];

private _massB = getMass _balloon;
private _massO = getMass _hookedObj;
