...
[{
    ...
    [{
        ...
        [ace_player, _bodyPart, (_damageVar select ([_bodyPart] call ace_medical_fnc_selectionNameToNumber)) + (GVAR(narcFactor)/50), ace_player, "explosive", -1] call ace_medical_fnc_handleDamage;
