...
_changeGasNitroxI_1 = 	["Change_Gas_NitroxI",	"Nitrox I",		"",		{[false, 4, 1] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
_changeGasNitroxII_1 = 	["Change_Gas_NitroxII",	"Nitrox II",	"",		{[false, 5, 1] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
_changeGasOxygen_1 = 	["Change_Gas_Oxygen",	"Oxygen",		"",		{[false, 6, 1] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
_changeGasTrimax_1 = 	["Change_Gas_Trimax",	"Trimax",		"",		{[false, 7, 1] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
_changeGasTrimax15_1 = 	["Change_Gas_Trimax15",	"Trimax 15/55",	"",		{[false, 8, 1] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
...
_changeGasNitroxI_2 = 	["Change_Gas_NitroxI",	"Nitrox I",		"",		{[false, 4, 2] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
_changeGasNitroxII_2 = 	["Change_Gas_NitroxII",	"Nitrox II",	"",		{[false, 5, 2] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
_changeGasOxygen_2 = 	["Change_Gas_Oxygen",	"Oxygen",		"",		{[false, 6, 2] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
_changeGasTrimax_2 = 	["Change_Gas_Trimax",	"Trimax",		"",		{[false, 7, 2] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
_changeGasTrimax15_2 = 	["Change_Gas_Trimax15",	"Trimax 15/55",	"",		{[false, 8, 2] call grad_divoMeter_fnc_refillTank},{true},{}] call ace_interact_menu_fnc_createAction;
